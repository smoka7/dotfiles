    ...
    text = function(bufnr)
        if lsp_comps.check_lsp(bufnr) then
            return {
                ...
                {lsp_comps.lsp_info({format = '  %s'}), 'magenta'}
            }
        end
        return ''
    end
...
basic.right = {
    ...
    text = function()
        return {
            {sep.left_rounded, 'sep_before'}, {b_components.file_encoding(),'text'},
            {'|', 'text'}, {b_components.line_col_lua, 'text'},
            {'', 'text'}, {b_components.progress_lua, 'text'},
...
local default = {
    ...
    active = {
        ...
        {sep.right_rounded, hl_list.Black}, basic.lsp_diagnos, basic.git,
        basic.divider,
        {git_comps.git_branch({icon = '  '}), {'green', 'black'}, 90},
        {' ', hl_list.Black}, basic.right, {' ', hl_list.Black}
    },
    inactive = {
        basic.file_name_inactive, basic.divider, basic.divider,
        basic.line_col_inactive, {'', hl_list.Inactive},
